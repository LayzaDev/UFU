...
SELECT DISTINCT relatorio.nome_cliente FROM deposito,
...
SELECT nome_cliente
FROM Cliente c
WHERE c.cidade_cliente = 'Belo Horizonte';
 
--08-Nomes de clientes que tem 'Santos' no nome
 
SELECT nome_cliente from Cliente c
...
WHERE deposito.nome_agencia='Pampulha' GROUP BY nome_agencia;
