...
SELECT Cliente.nome_cliente, saldo_deposito
...
and cliente.nome_cliente = deposito.nome_cliente
...
WHERE E.NOME_CLIENTE = D.NOME_CLIENTE AND
E.NUMERO_CONTA = D.NUMERO_CONTA AND
E.NOME_AGENCIA = D.NOME_AGENCIA
